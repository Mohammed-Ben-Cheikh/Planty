  ...
  <div class="admin-dashboard flex min-h-screen bg-gray-50">
    ...
    <aside class="sidebar w-64 bg-white shadow-lg flex flex-col fixed h-full z-10">
      ...
      <nav class="flex-grow p-4">
        ...
        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-8">
          Paramètres
        </p>
        <ul class="space-y-1">
          <li
    ...
    <div class="flex-grow ml-64 p-6">
      ...
      <header class="bg-white p-4 rounded-xl shadow-sm mb-6 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative">
            <span
              class="bg-red-500 text-white rounded-full w-5 h-5 absolute -top-1 -right-1 flex items-center justify-center text-xs"
              >3</span
            >
      ...
      <div v-if="activeSection === 'orders'" class="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex space-x-2">
            ...
            <button
              class="bg-gray-100 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium"
            >
              Exporter
            </button>
          </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="h-10 w-10 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center text-gray-500 font-medium"
                    >
                      {{ user.initials }}
                    </div>
                    <div class="ml-4">
