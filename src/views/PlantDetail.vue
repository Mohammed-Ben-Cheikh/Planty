          ...
          <div class="lg:w-1/2">
            <div class="relative bg-gray-100 h-96">
              <img
                :src="
                  plant.image ||
                  'https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3&auto=format&fit=crop&w=1500&q=80'
                "
                :alt="plant.name"
            ...
            <!-- Thumbnail images -->
            <div
              v-if="plant.gallery && plant.gallery.length > 0"
              class="flex overflow-x-auto p-2 space-x-2 bg-gray-50"
            >
              <div
                v-for="(image, index) in plant.gallery"
                :key="index"
            ...
            <div class="flex flex-col h-full">
              ...
              <div class="text-sm text-green-600 mb-2">
                ...
                <router-link :to="`/categories/${plant.category?.slug}`" class="hover:underline">{{
                  plant.category?.name || 'Toutes les plantes'
                }}</router-link>
              </div>
              ...
              <div class="flex items-center mb-6">
                ...
                <span
                  :class="{
                    'line-through text-gray-500': plant.sale,
                    'text-xl font-bold text-gray-800': !plant.sale,
                  }"
                  >{{ plant.price }}€</span
                >
              </div>
              ...
              <div class="flex items-center mb-6">
                <span
                  ...
                  :class="plant.in_stock ? 'bg-green-500' : 'bg-red-500'"
                ></span>
  ...
  methods: {
    ...
    addToCart() {
      ...
      notificationService.success(
        `${this.quantity} ${this.plant.name} ${this.quantity > 1 ? 'ont été ajoutés' : 'a été ajouté'} à votre panier`,
      )
    },
  },
}
