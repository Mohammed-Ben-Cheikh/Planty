<template>
    <main class="flex-grow container mx-auto px-4 sm:px-6 py-8 max-w-7xl">
        <div class="animate-fade-in">
            ...
            <!-- Plants Grid -->
            <div v-if="!isLoading && !error && filteredPlants.length > 0"
                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-10">
                <div v-for="plant in paginatedPlants" :key="plant.id"
            ...
            <!-- No plants message -->
            <div v-else-if="!isLoading && !error && filteredPlants.length === 0"
    ...
    computed: {
        filteredPlants() {
            ...
            if (this.filterCategory) {
                result = result.filter(plant =>
                    plant.category_id === this.filterCategory ||
                    plant.category?.id === this.filterCategory
                );
            }
