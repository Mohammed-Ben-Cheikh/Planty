  ...
  <main class="flex-grow container mx-auto px-4 sm:px-6 py-8 max-w-7xl">
    <div class="animate-fade-in">
      ...
      <div v-else-if="orders.length === 0" class="bg-gray-50 p-8 rounded-xl text-center">
        ...
        <p class="mt-2 text-sm text-gray-500">Vous n'avez pas encore effectué de réservation.</p>
        <div class="mt-6">
          <router-link
            to="/plants"
      ...
      <div v-else>
        ...
        <div class="space-y-6">
          ...
          >
            <div
              class="px-4 py-4 sm:px-6 flex justify-between items-center border-b border-gray-200"
            >
              <div>
                <h3 class="text-lg font-medium text-gray-900">
                  Réservation #{{ order.reference_no || order.id }}
                </h3>
                <p class="text-sm text-gray-500">Passée le {{ formatDate(order.created_at) }}</p>
              </div>
              <div>
            ...
            <div class="px-4 py-4 sm:px-6">
              ...
              <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                ...
                <div class="space-x-2">
                  <router-link
                    :to="`/reservations/${order.slug || order.id}`"
