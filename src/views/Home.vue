<template>
  <main class="flex-grow container mx-auto px-4 sm:px-6 py-8 max-w-7xl">
    <div class="plant-store">
      <!-- Hero Banner -->
      <div
        class="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white mb-8 shadow-lg"
      >
        <div class="flex justify-between items-center">
          <div class="max-w-2xl">
            <h1 class="text-3xl md:text-4xl font-bold">Découvrez notre collection de plantes 🌿</h1>
            <p class="mt-2 text-green-100">
              Des plantes d'intérieur magnifiques, livrées directement à votre porte avec des
              ...
              <div class="flex items-center mt-2">
                ...
                <div class="flex items-center space-x-1 text-xs text-gray-500">
                  <span
                    ...
                    :class="{ 'bg-green-500': plant.inStock, 'bg-red-500': !plant.inStock }"
                  ></span>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-10">
          <div
            v-for="(plant, index) in allPlants"
            :key="index"
            class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200"
          >
            <div class="relative">
      ...
      <div class="bg-gradient-to-r from-green-100 to-green-50 rounded-2xl p-8 mb-12">
        <div class="text-center max-w-2xl mx-auto">
          ...
          <p class="text-green-700 mb-6">
            Inscrivez-vous à notre newsletter pour recevoir des conseils d'entretien et des offres
            exclusives.
          </p>
    ...
    return {
      ...
      featuredPlants: [
        {
          ...
          species: 'Monstera',
          image:
            'https://images.unsplash.com/photo-1614594075952-b01e3e733000?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '29,99',
          difficulty: 'Facile',
          inStock: true,
        },
        {
          ...
          species: 'Ficus',
          image:
            'https://images.unsplash.com/photo-1597055181449-b9efc7a9afed?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '49,99',
          difficulty: 'Modérée',
          inStock: true,
        },
        {
          ...
          species: 'Calathea',
          image:
            'https://images.unsplash.com/photo-1602923668104-8d8f1b1df1c6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '34,99',
      ...
      allPlants: [
        ...
        },
        {
          ...
          image:
            'https://images.unsplash.com/photo-1613737693016-7a41c3f79cbb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '19,99',
          size: 'M',
          inStock: true,
          sale: false,
        },
        {
          ...
          image:
            'https://images.unsplash.com/photo-1551888419-7b7a520fe0ca?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '12,99',
          size: 'S',
          inStock: true,
          sale: false,
        },
        {
          ...
          image:
            'https://images.unsplash.com/photo-1593482892290-f54c7f8b7048?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '24,99',
          size: 'M',
          inStock: true,
          sale: false,
        },
        {
          ...
          species: 'Pilea',
          image:
            'https://images.unsplash.com/photo-1614594976461-f29a2d4d7344?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
          price: '16,99',
          size: 'S',
          inStock: true,
          sale: true,
