            ...
            <div v-if="shipping.country === 'FR'" class="pt-2">
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input
                    v-model="shipping.pickupInStore"
                    id="pickup"
                    type="checkbox"
                ...
                <div class="ml-3 text-sm">
                  ...
                  <p class="text-gray-500">
                    Récupérez votre commande dans notre boutique à Paris. Délai de préparation: 24h.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <label for="standard" class="ml-3 flex flex-col cursor-pointer">
                    <span class="block text-sm font-medium text-gray-700"
                      >Livraison standard (3-5 jours ouvrés)</span
                    >
                ...
                >
                  ...
                  <label for="express" class="ml-3 flex flex-col cursor-pointer">
                    <span class="block text-sm font-medium text-gray-700"
                      >Livraison express (1-2 jours ouvrés)</span
                    >
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              <div
                class="flex items-center p-3 border rounded-md"
                :class="
                  payment.method === 'card' ? 'border-green-500 bg-green-50' : 'border-gray-300'
                "
              >
                <input
                ...
                <label for="card" class="ml-3 flex flex-col cursor-pointer">
                  ...
                  <span class="block text-sm text-gray-500"
                    >Visa, MasterCard, American Express</span
                  >
                </label>
                <div class="ml-auto flex items-center">
                  <img
                    ...
                    alt="Visa"
                    class="h-6 w-10 object-contain mx-1"
                  />
                  <img
              ...
              <div
                class="flex items-center p-3 border rounded-md"
                :class="
                  payment.method === 'paypal' ? 'border-green-500 bg-green-50' : 'border-gray-300'
                "
              >
                <input
                  v-model="payment.method"
            ...
            <div v-if="payment.method === 'card'" class="pt-4 space-y-4">
              ...
              <div>
                <label for="nameOnCard" class="block text-sm font-medium text-gray-700"
        ...
        <div class="bg-white shadow-sm rounded-md sticky top-6">
          <div class="px-4 py-5 sm:p-6">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                  ...
                  <p class="text-gray-500">
                    ...
                    <a href="/terms" class="text-green-600 hover:underline"
            ...
            <div class="mt-4 flex items-center justify-center text-sm text-gray-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 text-gray-400 mr-1.5"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
...
export default {
  ...
  setup() {
    ...
    const discount = computed(() => {
      return cart.discount_applied ? subtotal.value * 0.1 : 0
    })
