    ...
    <div class="bg-white shadow-sm rounded-lg p-6 md:p-8">
      ...
      <div class="border-t border-gray-200 pt-6">
        <div class="flex justify-between items-center mb-6">
          ...
          <p class="text-sm text-gray-600">Commande #{{ orderId }}</p>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p class="text-sm">
                {{
                  order.shipping.pickupInStore
                    ? 'Retrait en magasin (sous 24h)'
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-8">
          ...
          <div class="space-y-2">
            ...
            <div class="flex justify-between text-sm">
              ...
              <p v-if="order.shippingCost > 0" class="text-gray-900">
            ...
            <div
              class="flex justify-between text-base font-medium border-t border-gray-200 pt-2 mt-2"
            >
              ...
              <p class="text-gray-900">
                {{
                  order.payment.method === 'card'
                    ? 'Carte bancaire ****' + order.payment.cardLastFour
                    : 'PayPal'
                }}
              </p>
            </div>
            ...
            <ul class="mt-2 space-y-2 text-sm text-gray-600">
              ...
              <li class="flex items-start">
                ...
                <p>
                  ...
                  <router-link to="/account/orders" class="text-green-600 hover:text-green-500"
              ...
              <li class="flex items-start">
                ...
                <p>
                  ...
                  <a href="/support" class="text-green-600 hover:text-green-500">service client</a>
                </p>
              </li>
            </ul>
          </div>
