<template>
  <main class="flex-grow container mx-auto px-4 sm:px-6 py-8 max-w-7xl">
    ...
    <div
      ...
      class="bg-gray-50 p-8 text-center rounded-xl"
    >
      <svg
      ...
      <p class="text-gray-600 mb-6">
        Découvrez notre collection de plantes et ajoutez vos favorites à votre panier.
      </p>
      <router-link
        to="/plants"
          ...
          <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
            ...
            <ul class="divide-y divide-gray-200">
              <li
                ...
                :key="index"
                class="p-4 sm:px-6 flex flex-col sm:flex-row sm:items-center"
              >
                <!-- Mobile remove button -->
                <button
                  @click="removeItem(item)"
                  class="sm:hidden self-end mb-2 text-gray-400 hover:text-red-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
                  ...
                  <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                    <div>
                      ...
                      <p class="mt-1 text-sm text-gray-700">
                        {{ item.price }}€
                        <span v-if="item.sale" class="line-through text-gray-400 ml-1"
                    ...
                    <div class="flex items-center gap-4 mt-4 sm:mt-0">
                      ...
                      <button
                        @click="removeItem(item)"
                        class="hidden sm:block text-gray-400 hover:text-red-500"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-5 w-5"
            ...
            <div class="px-4 py-5 sm:px-6">
              <div class="space-y-3">
                ...
                <div class="flex justify-between">
                  ...
                  <p v-if="shippingCost > 0" class="text-gray-900">
              ...
              <div v-if="!cart.discount_applied" class="mt-6">
                <div class="flex space-x-2 mt-1">
                  ...
                  <button
                    ...
                    :disabled="!promoCode"
                    class="flex-shrink-0 px-3 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50"
                  >
                    Appliquer
                  </button>
                </div>
              ...
              <p class="mt-4 text-center text-sm text-gray-500">Paiement 100% sécurisé</p>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
      ...
      this.cart = {
        items: [
          ...
          },
          {
            ...
            price: '39.99',
            image:
              'https://images.unsplash.com/photo-1606800052052-a08af7148866?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
            quantity: 2,
          },
        ],
        discount_applied: false,
    ...
    calculateTax() {
      ...
      this.tax = Math.round(this.subtotal * 0.2 * 100) / 100
    },
